...
def parse_args():
    parser = argparse.ArgumentParser(description="LODA inference")

    parser.add_argument("--config", type=str, default="../benchmark/benchmark_config/", help="Config directory")
    parser.add_argument("--expid", type=str, default="loda_SMD", help="Experiment id")
    parser.add_argument("--entity", type=str, default="machine-1-1", help="Entity id")
    parser.add_argument("--model_path", type=str, required=True, help="Path to fitted LODA model")
    ...
    parser.add_argument("--gpu", type=int, default=-1, help="Unused by LODA; kept for config compatibility")
...
"""
python inference_loda.py \
    --config ../benchmark/benchmark_config/ \
    --expid loda_SMD \
    --entity machine-1-1 \
    --model_path ../benchmark/benchmark_exp_details/SMD/LODA/loda_SMD/machine-1-1/loda_model.joblib \
    ...
    --threshold_file ../benchmark/benchmark_exp_details/SMD/LODA/loda_SMD/machine-1-1/thresholds.json \
    --index 0
